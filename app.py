...
questions = ["If one of us apologizes when our discussion deteriorates, the discussion ends.",
             ...
             "I think that one day in the future, when I look back, I see that my spouse and I have been in harmony "
             "with each other.",
...
def predict():
    ...
    return render_template('results.html', prediction_text=f"Chance for divorce {100 - output * 100}%")
